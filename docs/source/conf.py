...
# -*- coding: utf-8 -*-
#
# diffpy.batchpdfsuite documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("diffpy.batchpdfsuite")
except Exception:
...
# abbreviations
ab_authors = "Yuchen Xiao and members of the diffpy.batchpdfsuite community"
...
project = "diffpy.batchpdfsuite"
copyright = "%Y, contributors to the diffpy.batchpdfsuite community"
...
modindex_common_prefix = ["diffpy.batchpdfsuite"]
...
html_context = {
    "display_github": True,
    "github_user": "diffpy",
    "github_repo": "diffpy.batchpdfsuite",
    "github_version": "main",
...
basename = "diffpy.batchpdfsuite".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "diffpy.batchpdfsuite.tex",
        "diffpy.batchpdfsuite Documentation",
        ab_authors,
        "manual",
    ),
]
